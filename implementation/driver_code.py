...
def load_correct_file(which_mode):
    return {1: load_problem('../utils_code/pdp_utils/data/pd_problem/Call_7_Vehicle_3.txt'),
            ...
            3: load_problem('../utils_code/pdp_utils/data/pd_problem/Call_35_Vehicle_7.txt'),
            4: load_problem('../utils_code/pdp_utils/data/pd_problem/Call_80_Vehicle_20.txt'),
            5: load_problem('../utils_code/pdp_utils/data/pd_problem/Call_130_Vehicle_40.txt'),
            6: load_problem('../utils_code/pdp_utils/data/pd_problem/Call_300_Vehicle_90.txt')}[which_mode]


def filename(file: int):
    return {1: 'Call_7_Vehicle_3.txt',
            2: 'Call_18_Vehicle_5.txt',
            3: 'Call_35_Vehicle_7.txt',
            4: 'Call_80_Vehicle_20.txt',
            5: 'Call_130_Vehicle_40.txt',
            6: 'Call_300_Vehicle_90.txt'}[file]
